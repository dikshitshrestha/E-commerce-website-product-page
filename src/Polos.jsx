        ...
        <div className='h-full bg-black'>
            ...
            <div className='h-screen bg-white p-16 pr-0 flex'>
                <div className='flex justify-center w-3/6'>
                    <img src="https://image.hm.com/assets/001/04/0f/040f9a299c1cb0404cf936def90a9f654ffbd20e.jpg?imwidth=2160" alt="hoodie" className='h-96 w-64'/>
                    <img src="https://d29c1z66frfv6c.cloudfront.net/pub/media/catalog/product/zoom/fa0bf757bd60fd5be16bf3d6c86711038d06354a_xxl-1.jpg" alt="hoodie" className='h-96 w-64'/>
                    <img src="https://image.hm.com/assets/hm/88/c9/88c9189c154d505400fbd8d4b4c6e6d2136814ed.jpg?imwidth=2160" alt="hoodie" className='h-96 w-68'/>
                </div>
                <div className=' w-3/6 text-center bg-white p-5'>
                    <h1 className='text-4xl'><b>Polos for Men</b></h1>
                    ...
                    <p className='text-2xl mt-5 text-red-900'><b>Price: Rs 1200</b></p>
                    <div className='mt-5'>
