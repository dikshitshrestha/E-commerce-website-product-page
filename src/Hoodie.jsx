        ...
        <div className='h-full bg-black'>
            ...
            <div className='h-screen bg-white p-16 pr-0 flex'>
                ...
                <div className=' w-3/6 text-center bg-white p-5'>
                    ...
                    <div className='mt-3'>
                        <button className='mr-4 h-14 w-14 border-2 rounded-full hover:bg-red-600 text-xl'>S</button>
                        <button className='mr-4 h-14 w-14 border-2 rounded-full hover:bg-red-600 text-xl'>M</button>
                        <button className='mr-4 h-14 w-14 border-2 rounded-full hover:bg-red-600 text-xl'>L</button>
                        <button className='mr-4 h-14 w-14 border-2 rounded-full hover:bg-red-600 text-xl'>XL</button>
                        <button className='mr-4 h-14 w-14 border-2 rounded-full hover:bg-red-600 text-xl'>XXL</button>
                        <button className='mr-4 h-14 w-14 border-2 rounded-full hover:bg-red-600 text-xl'>XXXL</button>
                    </div>
