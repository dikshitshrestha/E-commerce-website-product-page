        ...
        <div className='h-full bg-black'>
            ...
            <div className='h-screen bg-white p-16 pr-0 flex'>
                <div className='flex justify-center w-3/6'>
                    <img src="https://lp2.hm.com/hmgoepprod?set=quality%5B79%5D%2Csource%5B%2Fb8%2F58%2Fb8589bd20b6ff0b0d7fdcae3864673cad5599a15.jpg%5D%2Corigin%5Bdam%5D%2Ccategory%5B%5D%2Ctype%5BLOOKBOOK%5D%2Cres%5Bm%5D%2Chmver%5B1%5D&call=url[file:/product/main]" alt="hoodie" className='h-96 w-64'/>
                    <img src="https://i.pinimg.com/736x/29/0a/8d/290a8da05e7ee855134297523a6e89a8.jpg" alt="hoodie" className='h-96 w-64'/>
                    <img src="https://image.hm.com/assets/hm/47/e6/47e6b33134bdaa5c29cdfd6fa0f7226ee9df045e.jpg?imwidth=2160" alt="hoodie" className='h-96 w-68'/>
                </div>
                <div className=' w-3/6 text-center bg-white p-5'>
                    <h1 className='text-4xl'><b>Aesthetic Coat for Men</b></h1>
