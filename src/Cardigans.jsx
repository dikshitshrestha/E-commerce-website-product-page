        ...
        <div className='h-full bg-black'>
            ...
            <div className='h-screen bg-white p-16 pr-0 flex'>
                <div className='flex justify-center w-3/6'>
                    <img src="https://lp2.hm.com/hmgoepprod?set=quality%5B79%5D%2Csource%5B%2F4a%2Fa9%2F4aa9edd6944e01d1ef54db612f660e1bfc4dad59.jpg%5D%2Corigin%5Bdam%5D%2Ccategory%5B%5D%2Ctype%5BLOOKBOOK%5D%2Cres%5Bm%5D%2Chmver%5B1%5D&call=url[file:/product/main]" alt="hoodie" className='h-96 w-64'/>
                    <img src="https://image.hm.com/assets/hm/1f/40/1f40eaca4d49ac90bbd4beec6d487a8083aba4a8.jpg?imwidth=2160" alt="hoodie" className='h-96 w-64'/>
                    <img src="https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/19893542/2022/9/10/4c190b79-8f37-43b5-bfad-0b944b399b3f1662749115640HMMenBlackSweaters1.jpg" alt="hoodie" className='h-96 w-68'/>
                </div>
                <div className=' w-3/6 text-center bg-white p-5'>
                    <h1 className='text-4xl'><b>Stylish Cardigans for Men</b></h1>
